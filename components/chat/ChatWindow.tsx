...
export function ChatWindow(props: {
  ...
  return (
    <div className={`h-full flex flex-col items-center p-4 md:p-8 rounded grow overflow-hidden ${(messages.length > 0 ? "border" : "")}`}>
      ...
      <div
        className="flex flex-col-reverse w-full mb-4 overflow-auto transition-[flex-grow] ease-in-out max-h-[600px]"
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          ...
          />
          <button type="submit" className="shrink-0 px-8 py-4 bg-blue-400 rounded w-28">
